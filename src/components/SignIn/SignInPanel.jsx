...
export default function SignInPanel({ auth, darkMode, setDarkmode }) {
  // auth
  ...
  return (
    <div className="xl:m-5 flex flex-col justify-center">
      ...
      <form className="flex flex-col mt-10 xl:ml-28 xl:mr-28 ml-10 mr-10 justify-center items-center">
        ...
        />
        <h1
          className="text-md self-end mb-2 font-semibold hover:underline text-primary cursor-pointer"
        ...
        ></Button>
        <h1
          className="text-md mt-2 font-semibold hover:underline text-primary cursor-pointer"
          onClick={signInAnon}
        >
      ...
      <h4 className="font-normal text-center mt-8 basis-0">
