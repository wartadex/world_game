...
export default function BorderGame({ score, setScore, setXpWon, setFinished }) {
  ...
  return (
    <>
      ...
      <div className="block sm:hidden m-4 text-start">
        <h1>
          For technical reasons, this game is not available on mobile yet. We invite you to try another device if you want to play border games. We apologize for the inconvenience caused
        </h1>
      </div>
    </>
  )
