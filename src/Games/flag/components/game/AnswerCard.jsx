  ...
  return (
    <>
      <div
        ...
        className="md:border-2 border-[1px] w-full dark:border-darkInput rounded-2xl mb-4 cursor-pointer flex justify-center items-center h-full transition hover:scale-110 text-center"
