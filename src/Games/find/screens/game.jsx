      ...
      {countriesInGame && countriesInGame.length > 0 && (
        <div className="sm:mt-12">
          ...
          {!endGame ? (
            ...
            <div className="flex justify-center text-lg ml-auto mr-auto mt-20 pb-[100px] items-center dark:text-lightBackground">
              <span className="bg-sky-600 w-2/5 rounded-md h-[56px]">
