        ...
        {countriesInvestigation?.length > 0 &&
          countriesInvestigation[round].propositions.map((c, index) => (
            <div
              ...
              className="border-2 lg:ml-8 lg:mr-8 md:p-4 w-full rounded-2xl mb-4 cursor-pointer h-14 md:h-20 flex justify-center items-center text-center transition hover:scale-125 dark:border-darkInput"
            >
              {c.name}
            </div>
          ))}
